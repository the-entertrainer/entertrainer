...
<template>
  <div id="app-root">
    ...
    <UiMenu v-if="!route.path.startsWith('/glass-lab') && !route.path.startsWith('/instructional-design') && !route.path.startsWith('/my-work/strong') && !route.path.startsWith('/tools/hangyourfriend') && !/^\/about\/?$/.test(route.path)" />
  </div>
</template>
