...
.ck__q + .ck__q { margin-top: 30rem; padding-top: 26rem; border-top: var(--stroke-hair) solid var(--line); }
...
.ck__opt.is-right { background: color-mix(in srgb, var(--mint) 34%, var(--paper)); border-width: var(--stroke); }
.ck__opt.is-wrong { background: color-mix(in srgb, var(--coral) 26%, var(--paper)); border-width: var(--stroke); }

.ck__box {
  flex: none; width: 22rem; height: 22rem; margin-top: 1rem;
  border: var(--stroke-hair) solid var(--ink); border-radius: var(--radius-xs);
...
.ck__fb {
  ...
  border-radius: var(--radius-m); border: var(--stroke-hair) solid var(--ink);
  border-left: 5rem solid var(--mint);
  background: var(--paper);
}
.ck__fb.is-wrong { border-left-color: var(--coral); }
