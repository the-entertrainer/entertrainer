...
/**
 * The contributor byline. One writer on this publication, which is exactly why
 * it is worth printing: everything here was made by a named person who can be
 * asked about it.
 */
withDefaults(defineProps<{ role?: string }>(), { role: '' })
