...
.wm__signal i { --wm-enter-delay: 0ms; position: relative; z-index: 1; display: block; width: calc(var(--wm-size) * .105); border-radius: calc(var(--wm-size) * .03); background: #4e28d8; transform-origin: center bottom; animation: wm-bar-enter 460ms var(--ease-spring) var(--wm-enter-delay) both; }
.wm__signal i:nth-child(2) { --wm-enter-delay: 55ms; background: #6458e4; }.wm__signal i:nth-child(3) { --wm-enter-delay: 110ms; background: #5d79e9; }.wm__signal i:nth-child(4) { --wm-enter-delay: 165ms; background: #5299e8; }.wm__signal i:nth-child(5) { --wm-enter-delay: 220ms; background: #8bc5f2; }
