...
const screens: Screen[] = [
  ...
  { lesson: 'Close', label: 'Takeaway', kind: 'summary', title: 'Use this workflow', body: ['Define the task. Name the information. Treat output as a candidate. Check important claims. Keep a person accountable for the decision.'] }
]
