...
<div class="taj">
    <header class="taj__head">
      ...
      <p class="taj__meta">{{ JAMAIS_VU_BLOG.category }} <span aria-hidden="true">·</span> {{ JAMAIS_VU_BLOG.minutes }} min read</p>
      <h1>{{ JAMAIS_VU_BLOG.title }}</h1>
      <p class="taj__dek">{{ JAMAIS_VU_BLOG.dek }}</p>
    </header>
