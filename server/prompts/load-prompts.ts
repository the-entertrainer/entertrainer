...
export function buildComposeSystemPrompt(): string {
  ...
  return [
    ...
    '  "socialHook": string (LinkedIn/OG/Twitter card description ONLY — 100–150 chars; NOT a copy of dek; front-load benefit/curiosity/specificity),',
    '  "socialTitle": string (LinkedIn/OG/Twitter card title ONLY — ~40–60 chars; must carry the pull alone when mobile hides description),',
    '  "category": string,',
    '  "minutes": number,',
    ...
    '- socialTitle: required for LinkedIn paste. ~40–60 characters. OG title that stands alone when mobile hides the description. Not a one-word brand label.',
